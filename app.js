(() => {
  ...
  let products=[]; let cart=JSON.parse(localStorage.getItem('drapeAuraCart')||'[]'); let currentFilter='All';
  ...
  $('year').textContent=new Date().getFullYear();renderCart();load();
})();
